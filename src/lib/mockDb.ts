...
const INITIAL_ASSETS: Asset[] = [
  ...
  { id: 'a6666666-6666-6666-6666-666666666666', tag: 'AF-0006', name: 'Conference Room A1', category_id: SEED_CAT_FURN, serial_number: null, acquisition_date: '2025-02-10', acquisition_cost: 0, condition: 'good', location: 'HQ Floor 1', department_id: null, photo_url: null, is_bookable: true, status: 'available', created_at: new Date().toISOString() },
  { id: 'a7777777-7777-7777-7777-777777777777', tag: 'AF-0007', name: 'Executive Boardroom', category_id: SEED_CAT_FURN, serial_number: null, acquisition_date: '2024-08-15', acquisition_cost: 0, condition: 'good', location: 'HQ Penthouse', department_id: null, photo_url: null, is_bookable: true, status: 'available', created_at: new Date().toISOString() },
  { id: 'a8888888-8888-8888-8888-888888888888', tag: 'AF-0008', name: 'Training Lab Delta', category_id: SEED_CAT_FURN, serial_number: null, acquisition_date: '2024-12-01', acquisition_cost: 0, condition: 'good', location: 'Annex Building', department_id: null, photo_url: null, is_bookable: true, status: 'available', created_at: new Date().toISOString() },
  { id: 'a9999999-9999-9999-9999-999999999999', tag: 'AF-0009', name: 'Company Electric Sedan', category_id: SEED_CAT_VEHI, serial_number: 'SD-7711Z', acquisition_date: '2025-05-12', acquisition_cost: 45000, condition: 'good', location: 'HQ Garage B', department_id: null, photo_url: null, is_bookable: true, status: 'available', created_at: new Date().toISOString() },
  { id: 'a1010101-1010-1010-1010-101010101010', tag: 'AF-0010', name: 'Portable Audio Kit', category_id: SEED_CAT_ELEC, serial_number: 'AU-1122D', acquisition_date: '2025-06-01', acquisition_cost: 1500, condition: 'good', location: 'IT Helpdesk', department_id: null, photo_url: null, is_bookable: true, status: 'available', created_at: new Date().toISOString() },
];
